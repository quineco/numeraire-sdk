...
export type Numeraire = {
  ...
  instructions: [
    ...
    {
      name: "replacePoolToken";
      discriminator: [161, 238, 54, 16, 252, 48, 193, 114];
      accounts: [
        {
          name: "pool";
          writable: true;
  ...
  errors: [
    ...
    {
      code: 6037;
      name: "invalidPairParams";
      msg: "Invalid pair params";
    },
    {
      code: 6038;
      name: "poolNotMutable";
      msg: "Pool is not mutable";
    }
  ];
  types: [
    {
